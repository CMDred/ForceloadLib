...
$execute if score #ForceloadLib.IsForceloaded ForceloadLib matches 1 unless data storage forceloadlib:zprivate AllChunks[{Dimension:"$(Dimension)",X:$(X),Z:$(Z)}] run scoreboard players set #ForceloadLib.IsLegacyForceloaded ForceloadLib 1
