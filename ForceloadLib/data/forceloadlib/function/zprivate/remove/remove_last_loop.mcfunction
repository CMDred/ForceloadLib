...
execute unless data storage forceloadlib:temporary CurrentReference.Protected unless data storage forceloadlib:temporary {CurrentReference:{Loading:1b,Force:1b}} run return run data remove storage forceloadlib:temporary RemoveChunk.References[-1]
