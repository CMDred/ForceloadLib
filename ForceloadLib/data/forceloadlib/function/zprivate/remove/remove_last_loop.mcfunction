...
execute unless data storage forceloadlib:temporary CurrentReference.Protected unless data storage forceloadlib:temporary {CurrentReference:{Loading:1b,Force:1b}} run return run function forceloadlib:zprivate/remove/remove_last_reference
