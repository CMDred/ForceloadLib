# Remove the last removable reference
...
execute if data storage forceloadlib:temporary CurrentReference.Duration run function forceloadlib:zprivate/remove/timer_chunks/remove_from_list with storage forceloadlib:temporary CurrentReference
