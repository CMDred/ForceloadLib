...
execute if score #ForceloadLib.ReferenceCount ForceloadLib matches 1 run return run function forceloadlib:zprivate/remove/remove_forceload_from_position with storage forceloadlib:temporary RemoveChunk
