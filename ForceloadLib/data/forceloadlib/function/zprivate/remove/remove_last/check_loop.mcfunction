...
execute unless data storage forceloadlib:temporary CurrentReference.Protected unless data storage forceloadlib:temporary CurrentReference.Force run return run function forceloadlib:zprivate/remove/remove_last/remove_reference
