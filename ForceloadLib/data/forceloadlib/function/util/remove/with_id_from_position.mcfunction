...
execute if score #ForceloadLib.ReferenceCount ForceloadLib matches 0 run function forceloadlib:zprivate/remove/remove_forceload_from_position with storage forceloadlib:temporary RemoveChunk
